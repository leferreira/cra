		...
		Form<Retorno> formManual = new Form<Retorno>("formManual"){
            ...
            protected void onSubmit(){
				...
				try{
					...
					Integer codigoIBGE = Municipio.class.cast(codigoIbge.getDefaultModelObject()).getCodigoIBGE();
	...
	private void adicionarFormularioCodigo(){
		Form<Retorno> formCodigo = new Form<Retorno>("formCodigo"){
            ...
            protected void onSubmit(){
				...
				try{
					Integer codigoIbge = new Integer(codigoInstrumento.getModelObject().substring(1, 8));
