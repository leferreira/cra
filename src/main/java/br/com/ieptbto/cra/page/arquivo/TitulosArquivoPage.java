...
public class TitulosArquivoPage extends BasePage<Remessa> {
	...
	private DefaultDataTable<ViewTitulos, String> dataTableTitulos() {
		DataProvider<ViewTitulos> dataProvider = new DataProvider<ViewTitulos>(tituloMediator.consultarViewTitulosPorRemessa(remessa));
		List<IColumn<ViewTitulos, String>> columns = TituloViewColumns.generateDataTableColumnsFromTituloView();
		return new DefaultDataTable<ViewTitulos, String>("table", columns, dataProvider, 10000);
	}
